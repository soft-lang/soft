...
-- \ir MAP_FUNCTIONS/ENTER_FUNCTION_IDENTIFIER.sql
...
\ir EVAL/LEAVE_REST_EXPRESSION.sql
\ir EVAL/LEAVE_FIRST_EXPRESSION.sql
\ir EVAL/LEAVE_LAST_EXPRESSION.sql
\ir EVAL/LEAVE_HASH.sql
\ir EVAL/LEAVE_LENGTH_EXPRESSION.sql
\ir EVAL/LEAVE_PUSH_EXPRESSION.sql
