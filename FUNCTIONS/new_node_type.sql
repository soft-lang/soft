...
INSERT INTO NodeTypes ( LanguageID,  NodeType,  Literal, LiteralLength,           LiteralPattern,       NodePattern,  ValueType,  Input,  Output,  PreVisitFunction,  PostVisitFunction,  Prologue,  Epilogue,  NodeGroup)
VALUES                (_LanguageID, _NodeType, _Literal, length(_Literal), '^('||_LiteralPattern||')', _NodePattern, _ValueType, _Input, _Output, _PreVisitFunction, _PostVisitFunction, _Prologue, _Epilogue, _NodeGroup)
