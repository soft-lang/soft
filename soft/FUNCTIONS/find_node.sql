-- SELECT Find_Node(82, '<- VARIABLE <- FUNCTION_DECLARATION <- STORE_ARGS')
-- 80
-- SELECT Find_Node(80, '-> FUNCTION_DECLARATION -> VARIABLE -> FUNCTION_CALL')
-- 82

CREATE OR REPLACE FUNCTION Find_Node(_NodeID integer, _Path text) RETURNS integer
LANGUAGE plpgsql
AS $$
DECLARE
_SQL text;
