...
INSERT INTO Log (NodeID, PhaseID,  Severity,  Message,  SourceCodeCharacters,  NodeID,  NodeIDs)
SELECT          _NodeID, PhaseID, _Severity, _Message, _SourceCodeCharacters, _NodeID, _NodeIDs
